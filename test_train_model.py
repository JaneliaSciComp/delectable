...
if __name__ == "__main__":
    ...
    targets_folder_path = os.path.join(script_folder_path, 'dave-lius-targets')
    model_folder_path = os.path.join(script_folder_path, 'dave-lius-targets-trained-model')
