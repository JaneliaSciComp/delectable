...
def CreateVideo(clip, Dataframe, pcutoff, colormap_name, alphavalue, cropping, dotsize, x1, x2, y1, y2,
                frames_folder_path, output_file_path):
...
def make_labeled_video(model_folder_path, video_file_path, h5_file_path):
    ...
    with tempfile.TemporaryDirectory(prefix=generalized_slash_tmp_path + "/") as scratch_folder_path :
        ...
        CreateVideo(clip, Dataframe, pcutoff, colormap_name, alphavalue, cropping, dotsize, x1, x2, y1, y2, scratch_folder_path, output_file_path)
...
if __name__ == '__main__':
    ...
    make_labeled_video(model_folder_path, video_file_path, h5_file_path)
