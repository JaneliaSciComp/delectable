...
if __name__ == "__main__":
    ...
    script_under_test_path = os.path.join(script_folder_path, 'apply_model_on_cluster')
    ...
    h5_file_path = os.path.join(script_folder_path, 'test-apply-model-output.h5')

    # Run the training
    return_value = subprocess.call([script_under_test_path, model_folder_path, video_file_path, h5_file_path])
    if return_value != 0:
